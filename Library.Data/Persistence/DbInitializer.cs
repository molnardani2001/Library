...
namespace Library.Data
{
    ...
    public static class DbInitializer
    {
        ...
        private static UserManager<Librarian> _userManager = null!;
        private static RoleManager<IdentityRole<int>> _roleManager = null!;

        /// <summary>
        /// Adatbázis inicializálása
        /// </summary>
        /// <param name="context">Kontextus</param>
        /// <param name="imageDirectory">Képek elérési útvonala</param>
        public static void Initialize(IServiceProvider serviceProvider, string imageDirectory)
        {
            ...
            _userManager = serviceProvider.GetRequiredService<UserManager<Librarian>>();
        ...
        private static void SeedVolumes()
        {
            ...
            {
                var vols = rnd.Next(1, 8);
                for(int i = 1; i <= vols; ++i)
                {
        ...
        /// <summary>
        /// Látogatók inicializálása
        /// </summary>
        private static void SeedVisitors()
        {
            //var users = new List<Visitor>
            //{
            //    new Visitor
            //    {
            //        Name = "Molnár Dániel",
            ...
            //        Email = "dani.molnar2001@gmail.com",
            //        PhoneNumber = "+36302491840",
            //        UserChallenge = "wapa"
            //    }
            //};

            //foreach(Visitor visitor in users)
            //{
        ...
        private static void SeedLibrarians()
        {
            var admin = new Librarian()
            {
                UserName = "admin",
                Name = "Molnár Dániel",
                Email = "ihn8hy@infle.te.hu",
                PhoneNumber = "+36302491840"
            };

            var adminPassword = "Danika2001";
            //var adminRole = new IdentityRole<int>("administrator");

            var result1 = _userManager.CreateAsync(admin, adminPassword).Result;
            //var result2 = _roleManager.CreateAsync(adminRole).Result;
            //var result3 = _userManager.AddToRoleAsync(admin,adminRole.Name).Result;

            //_context.Librarians.Add(admin);
            //_context.SaveChanges();
        }
    }
}
